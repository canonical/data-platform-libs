...
class TestCharm(unittest.TestCase):
    ...
    def test_action_params_parsing_ok(self):
        ...
        self.assertEqual(sorted(logger.output), ["INFO:tests.v0.unit.test_data_models:my-host:80"])
    ...
    def test_relation_databag_io(self):
        ...
        self.assertEqual(
            logger.output, ["INFO:tests.v0.unit.test_data_models:Field type: <class 'float'>"]
        )
